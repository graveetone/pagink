...
5.times do
    ...
    image_link = ImageLink.create(url: Faker::Internet.url)
...
15.times do
    book = Book.create(title: Faker::Book.title, pages_count: Faker::Number.within(range: 100..3000), isbn: Faker::Number.number(digits: 10).to_s, description: Faker::Lorem.paragraph(sentence_count: 5), publisher: Publisher.all.sample)
    ...
    gink = Gink.create(title: Faker::Lorem.paragraph(sentence_count: 1), text: Faker::Lorem.paragraph(sentence_count: 4), author: User.all.sample)    
...
30.times do
    ...
    message = Message.create(author: sender, recipient: (User.all - [sender]).sample, text: Faker::Lorem.paragraph(sentence_count: 1))
    ...
    notification = Notification.create(title: Faker::Lorem.paragraph(sentence_count: 1), payload: Faker::Lorem.paragraph(sentence_count: 1), user: User.all.sample)
